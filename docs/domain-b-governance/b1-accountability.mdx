...
<div style={{display:'flex',gap:'0.5rem',flexWrap:'wrap',marginBottom:'1.5rem'}}>
  ...
  <span className="framework-chip">EU AI Act Art. 26</span> <span className="framework-chip">APRA CPS 230</span> <span className="framework-chip">FAR (AU)</span> <span className="framework-chip">ISO 42001 Cl. 5</span>
</div>
...
**[▶ Play this scenario in the AI Risk Training Module](https://app.airiskpractice.org/#/scenario/b1-accountability)** — AI Accountability Gaps, four personas, ~12 minutes.
