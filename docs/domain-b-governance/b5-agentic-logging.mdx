...
**[▶ Play the governance scenario](https://app.airiskpractice.org/#/scenario/b1-accountability)** — Nobody's Problem: Accountability Gaps in AI Systems (related scenario).
