...
**AI-generated celebrity impersonation misinformation (2025):** An AI-generated image of former US President Barack Obama DJing in Arizona was shared widely, reaching millions of people and leading many to mistakenly believe the image was real. Demonstrates that AI-generated celebrity impersonation content can spread as misinformation at scale even without malicious coordinated amplification. Source: AIID monitoring run, May 2026.

**OpenAI covert influence operation disruptions (2024–2025):** OpenAI publicly documented disrupting multiple covert influence operations (IO) that used its models to generate synthetic content for political manipulation — including state-affiliated networks using AI to produce fake social media personas, translated propaganda, and fabricated quotes attributed to real political figures. The documented cases span multiple jurisdictions and demonstrate that AI-generated content is now a routine component of coordinated disinformation campaigns. Source: OpenAI threat intelligence reporting (2024); AIID monitoring run, May 2026.

**Coordinated inauthentic behaviour networks using AI (2024–2025):** Meta and other platform operators removed multiple coordinated inauthentic behaviour (CIB) networks that used AI to generate synthetic content — including networks linked to conflicts in Ukraine and Russia, and others manufacturing artificial grassroots opposition in policy debates. AI-generated content in CIB operations lowers production costs for influence campaigns and increases volume beyond what human operators alone can sustain. Source: Meta transparency reporting; AIID monitoring run, May 2026.
...
**[▶ Play this scenario in the AI Risk Training Module](https://b-gowland.github.io/ai-risk-training/#/scenario/e3-misinformation)** — AI-Generated Synthetic Content & Credential Integrity, four personas, ~12 minutes.
