...
<div style={{display:'flex',gap:'0.5rem',flexWrap:'wrap',marginBottom:'1.5rem'}}>
  ...
  <span className="framework-chip">EU AI Act Art. 50</span> <span className="framework-chip">NIST AI 600-1</span> <span className="framework-chip">DIGI Disinformation Code (AU)</span> <span className="framework-chip">CDSA</span>
</div>
