...
description: "AI models produce systematically different outcomes for individuals based on protected characteristics — even when those characteristics are not explicit inputs."
---
...
<div style={{display:'flex',gap:'0.5rem',flexWrap:'wrap',marginBottom:'1.5rem'}}>
  ...
  <span className="framework-chip">EU AI Act Art. 10</span> <span className="framework-chip">NIST AI RMF MEASURE 2.11</span> <span className="framework-chip">Colorado SB21-169</span>
</div>
...
AI models can produce systematically worse outcomes for people from certain groups based on protected characteristics — through proxy variables. Postcode correlates with race. Name patterns correlate with gender. A model can learn these correlations and reproduce discriminatory outcomes without ever receiving race or gender as an input. The SafeRent settlement ($2.275M, December 2024 final approval) established that algorithmic discrimination is an enforceable legal liability.
...
<Tabs>
  ...
  If your organisation uses AI for any decision affecting people — credit, insurance, employment, housing, benefits — fairness testing is a compliance requirement. The SafeRent settlement ($2.275M, December 2024 final approval) established this. The audit finding means fairness testing has not been conducted. What you are approving is pre-deployment bias testing and ongoing fairness monitoring.
  </TabItem>
  ...
  AI is increasingly used to screen job applications, assess credit, set insurance premiums, and rank housing applicants — often before a human ever looks at your file. These systems can produce systematically worse outcomes for certain groups, even when protected characteristics aren't directly used as inputs.

  **If you've been automatically rejected** from a job, loan, insurance policy, or rental: you may have the right to ask why. In most Australian states, equal opportunity legislation applies to automated decisions. In the EU, AI Act Article 86 creates an explicit right to explanation.

  **What to do:** ask HR (or the lender, insurer, or landlord) what criteria the AI tool used and whether those criteria were disclosed in advance. A professional, written request is well within your rights and often produces results.

  **If criteria weren't disclosed:** that's a real problem worth raising. The same undisclosed threshold will screen out the next person unless someone flags it.
...
**Facial recognition wrongful arrests — documented pattern (2020–2025):** More than fourteen individuals have been wrongfully arrested in the United States due to misidentification by facial recognition systems. The pattern is documented across multiple jurisdictions: in the majority of documented cases the wrongfully arrested individual is a Black man. Error rates for darker-skinned individuals are significantly higher than for lighter-skinned individuals in most evaluated systems — a finding established by the Gender Shades study (Buolamwini & Gebru, PMLR 81:1–15, 2018) and subsequently documented in NIST facial recognition evaluations (FRVT 2019). Law enforcement use of facial recognition without adequate human review and exculpatory evidence requirements has produced foreseeable discriminatory outcomes. Sources: AIID monitoring run May 2026; NIST FRVT; Buolamwini & Gebru (2018).
...
**[▶ Play the at-work scenario](https://app.airiskpractice.org/#/scenario/e1-bias)** — Algorithmic Bias & Discrimination.

**[▶ Play the at-home scenario](https://app.airiskpractice.org/#/scenario/home-algorithm-said-no)** — The Algorithm Said No.
