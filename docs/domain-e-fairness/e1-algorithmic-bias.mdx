...
**[▶ Play this scenario in the AI Risk Training Module](https://app.airiskpractice.org/#/scenario/e1-bias)** — Algorithmic Bias & Discrimination, four personas, ~12 minutes.
