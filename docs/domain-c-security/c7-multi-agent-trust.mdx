...
**[▶ Play this scenario](https://app.airiskpractice.org/#/scenario/c7-multi-agent-trust)** — The Footnote That Forwarded Everything: Multi-Agent Trust Boundaries & Cascading Prompt Injection.
