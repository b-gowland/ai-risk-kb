...
description: "When multiple AI agents work together — one orchestrating others, each calling tools and passing results — a malicious instruction injected at any point in the chain can propagate through the entire system, escalating in impact as it passes through agents with progressively broader permissions."
---
