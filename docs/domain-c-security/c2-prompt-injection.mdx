...
*For use in training exercises. The [AI Risk Training Module](https://github.com/b-gowland/ai-risk-training) uses these seeds to generate interactive scenarios.*
