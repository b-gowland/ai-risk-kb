...
**[▶ Play the prompt injection scenario in the AI Risk Training Module](https://app.airiskpractice.org/#/scenario/c2-prompt-injection)** — Prompt Injection & AI System Manipulation (parent scenario).
