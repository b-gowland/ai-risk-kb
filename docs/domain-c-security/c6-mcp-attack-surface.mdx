...
description: "Model Context Protocol (MCP) servers give AI agents access to tools, data, and external services — and every connected MCP server is a potential attack surface that can be used to hijack, poison, or exfiltrate through the agent."
---
