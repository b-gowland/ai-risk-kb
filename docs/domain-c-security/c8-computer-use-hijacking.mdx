...
**[▶ Interactive scenario — coming soon](https://app.airiskpractice.org/#/scenario/c8-computer-use-hijacking)** — The Verification Step That Wasn't: Computer-Use Agent Hijacking via Injected Visual Instructions.
