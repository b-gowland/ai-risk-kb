...
description: "AI-generated synthetic audio, video, and images used to impersonate individuals, fabricate evidence, and manipulate financial decisions — now accessible to attackers with no specialised expertise."
---
...
<Tabs>
  ...
  AI can clone anyone's voice from a short audio clip — a birthday video, a voicemail, a social media post. Scammers use this to impersonate family members in distress, creating fake urgency to get you to send money fast.

  **The defence is simple:** hang up and call back on the number you already have. If it was really them, they'll answer. If it wasn't, the scam is over.

  **What to watch for:** urgency ("I need this in 20 minutes"), secrecy ("don't tell anyone"), and an account number you don't recognise. These three together are the attack.

  **If you've already sent money:** call your bank immediately — say "scam transfer." Every minute matters. Then report to [Scamwatch](https://scamwatch.gov.au) (Australia) to protect others.

  **Want to see how this plays out?** [Try the scenario →](https://app.airiskpractice.org/)
  </TabItem>
</Tabs>
...
**AI-generated images in pet and missing animal scams (2024–2025):** Multiple documented cases of scammers using AI-generated images of missing pets to defraud owners. In one case, a Florida family was targeted with an AI-generated picture of their missing puppy; in another, a family was extorted for $2,700 before their dog was found. The AI images are used to establish false credibility — appearing to show the animal in the scammer's possession. Multiple incidents reported by US news outlets 2024–2025 and logged in the AI Incident Database.

**AI-generated evidence fabrication for false crime reports (2024–2025):** Multiple law enforcement cases documented where AI-generated images were used to fabricate evidence: a St Petersburg, Florida woman used AI-generated images in a false crime report (2024); a separate case involved a woman convicted for using a ChatGPT-generated image in a false rape accusation. Demonstrates that deepfake technology has lowered the barrier to fabricating physical evidence in criminal proceedings. Source: AIID monitoring run, May 2026.

**Deepfake harassment in educational settings (2024–2025):** Multiple school-based incidents documented involving non-consensual deepfake images of students and staff. One documented case involved AI-generated images targeting 21 female students at a single school. MITRE ATLAS v5.6 explicitly categorises deepfake-assisted phishing as an attack technique, reflecting that synthetic media is now a standard component of social engineering toolkits. Sources: AIID monitoring run May 2026; MITRE ATLAS v5.6.0.

**Aadhaar identity document deepfake fraud (2025):** Ahmedabad, India police arrested four individuals who used deepfake technology to manipulate Aadhaar biometric identity documents for financial fraud. Demonstrates deepfakes moving from impersonation of people to manipulation of official identity documents. Source: AIID monitoring run, May 2026.
...
**[▶ Play this scenario](https://app.airiskpractice.org/#/scenario/home-voice-clone)** — Deepfakes & Synthetic Media Fraud.
