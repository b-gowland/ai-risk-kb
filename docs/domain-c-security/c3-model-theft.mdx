...
description: "Adversaries reconstruct a proprietary AI model by querying it repeatedly and using the outputs to train a surrogate — stealing the IP without accessing model weights."
---
...
<div style={{display:'flex',gap:'0.5rem',flexWrap:'wrap',marginBottom:'1.5rem'}}>
  ...
  <span className="framework-chip">NIST AI RMF GOVERN 6.2</span> <span className="framework-chip">MITRE ATLAS AML.T0005</span> <span className="framework-chip">OWASP ML05</span> <span className="framework-chip">ISO 27001</span>
</div>
