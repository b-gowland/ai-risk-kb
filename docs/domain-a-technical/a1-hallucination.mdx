...
description: "AI systems produce outputs that are factually wrong or fabricated, presented with confidence and no indication of uncertainty."
---
...
<div style={{display:'flex',gap:'0.5rem',flexWrap:'wrap',marginBottom:'1.5rem'}}>
  ...
  <span className="framework-chip">OWASP LLM09 Misinformation</span>
</div>
...
**[▶ Play the at-work scenario](https://app.airiskpractice.org/#/scenario/a1-hallucination)** — Hallucination & Confabulation.

**[▶ Play the at-home scenario](https://app.airiskpractice.org/#/scenario/home-ai-answer)** — The Answer That Wasn’t.
