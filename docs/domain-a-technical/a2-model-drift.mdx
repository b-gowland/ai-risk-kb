...
**[▶ Play this scenario in the AI Risk Training Module](https://app.airiskpractice.org/#/scenario/a2-model-drift)** — Model Drift & Performance Degradation, four personas, ~13 minutes.
