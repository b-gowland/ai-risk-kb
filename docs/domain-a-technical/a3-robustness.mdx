...
**[▶ Play this scenario in the AI Risk Training Module](https://app.airiskpractice.org/#/scenario/a3-robustness)** — AI Robustness & Operational Design Domain Failure, four personas, ~13 minutes.
