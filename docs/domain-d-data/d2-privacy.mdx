...
description: "AI systems create multiple vectors for personal information breaches — through model memorisation, inference data transmission, and agent exfiltration."
---
...
<div style={{display:'flex',gap:'0.5rem',flexWrap:'wrap',marginBottom:'1.5rem'}}>
  ...
  <span className="framework-chip">Privacy Act 1988 (Cth) / APPs</span> <span className="framework-chip">GDPR (EU)</span> <span className="framework-chip">EU AI Act Art. 10/26</span>
</div>
...
AI systems create privacy risks beyond traditional data handling. Models can memorise and reproduce personal data from training. Inference processes transmit data to external processors that may retain it. AI agents can exfiltrate data if compromised. The Samsung case (2023) demonstrates that employees have submitted sensitive data to public AI tools without understanding the exposure risk.
...
<Tabs>
  ...
  AI systems create privacy risks that go beyond traditional data handling. The Samsung case (2023) demonstrates that employees have submitted sensitive data to public AI tools — in three separate incidents within 20 days of being granted access. The audit finding means your privacy controls for AI deployments are insufficient. Approving remediation means funding PIAs for AI systems, enterprise API tier requirements, and an acceptable use policy.
  </TabItem>
...
**[▶ Play this scenario](https://app.airiskpractice.org/#/scenario/d2-privacy)** — Privacy & AI Data Exposure.
