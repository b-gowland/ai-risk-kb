...
description: "AI systems trained on publicly available content may reproduce copyrighted material, and AI-generated code may carry licence contamination risks."
---
...
**Jurisdiction notes:** AU — Copyright Act 1968 — reproduction of a substantial part of a copyright work without licence or exception constitutes infringement; the test is qualitative (importance of the reproduced portion) not just quantitative | EU — EU AI Act Art. 53(1)(d) — providers of general purpose AI models must publish a sufficiently detailed summary of training data used; deployers must comply with copyright law. EU DSM Directive Art. 3 — text and data mining exception for scientific research (research and cultural-heritage organisations); Art. 4 — general TDM exception for other uses, subject to rightsholder opt-out, so commercial AI use must check for reserved rights; Art. 17 — platforms may have additional obligations | US — copyright in AI outputs is unsettled; US Copyright Office (2023, 2024) guidance — AI-generated content without sufficient human authorship is not copyrightable, creating both a risk (your AI content may not be protectable) and an obligation (you cannot claim copyright in reproduced AI output)
...
**AI-generated audiovisual content reproducing copyrighted works (2025):** A documented case involved an AI tool used to generate short video clips described as nearly identical to sequences from a copyrighted Beastie Boys music video. The case illustrates that AI reproduction risk extends beyond text and images to audiovisual works — and that generated content can be close enough to an original to raise infringement questions even when not directly copying frames. Source: AIID monitoring run, May 2026.
...
**[▶ Play this scenario](https://app.airiskpractice.org/#/scenario/d3-ip)** — AI-Generated Code & Licence Contamination.
