...
description: "AI model performance is fundamentally constrained by training data quality — biased, incomplete, or unrepresentative data produces models that systematically fail for underrepresented groups."
---
...
**Facial recognition error rates (Gender Shades study, 2018):** MIT Media Lab researchers Joy Buolamwini and Timnit Gebru documented error rates of up to 34.7% for darker-skinned women vs under 1% for lighter-skinned men across commercial facial recognition systems from IBM, Microsoft, and Face++. Root cause: training data overwhelmingly composed of lighter-skinned faces. IBM subsequently discontinued its facial recognition product in 2020. The research contributed to multiple wrongful arrest cases being re-examined. (Buolamwini & Gebru, "Gender Shades," Proceedings of Machine Learning Research 81:1–15, 2018; MIT News, February 2018)
