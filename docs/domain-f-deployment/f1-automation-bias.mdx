...
description: "Users excessively trust AI outputs, reducing independent verification even when the AI is wrong — one of the three most pervasive and difficult-to-mitigate generative AI risks per NIST."
---
...
**[▶ Play this scenario](https://app.airiskpractice.org/#/scenario/f1-automation-bias)** — Automation Bias & Overreliance.
