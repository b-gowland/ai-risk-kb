...
description: "Employees use unauthorised, unmanaged AI tools for work tasks — submitting sensitive data to systems outside organisational control."
---
...
<div style={{display:'flex',gap:'0.5rem',flexWrap:'wrap',marginBottom:'1.5rem'}}>
  ...
  <span className="framework-chip">APRA CPS 234</span> <span className="framework-chip">Privacy Act 1988 (Cth)</span> <span className="framework-chip">NIST AI RMF GOVERN 2</span> <span className="framework-chip">EU AI Act Art. 26</span>
</div>
...
**EU:** GDPR Art. 28 — any tool processing personal data on behalf of your organisation requires a Data Processing Agreement. Consumer-tier AI tools typically do not offer a DPA. Art. 32 — technical and organisational measures for data security must address unauthorised processing pathways. Art. 83 — fines for Art. 32 violations up to €10M or 2% of global annual turnover. EU AI Act Art. 26 — deployers of AI systems must implement appropriate technical and organisational measures; an approved tools governance framework is part of this obligation.
...
**Samsung / ChatGPT (March 2023):** Three separate incidents within 20 days of Samsung permitting ChatGPT use. Engineers submitted proprietary source code for bug fixing, code optimisation, and meeting transcription. Prompted Samsung to ban external AI tool use entirely. (CIO Dive, April 2023; Gizmodo, April 2023; AI Incident Database #768)
...
**[▶ Play this scenario](https://app.airiskpractice.org/#/scenario/f2-shadow-ai)** — Shadow AI & Data Exposure.
