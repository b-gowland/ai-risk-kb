...
**[▶ Play the scope creep scenario](https://app.airiskpractice.org/#/scenario/f3-scope-creep)** — Scope Creep & Deployment Beyond Intended Use (parent scenario).
