...
<div style={{display:'flex',gap:'0.5rem',flexWrap:'wrap',marginBottom:'1.5rem'}}>
  ...
  <span className="framework-chip">EU AI Act Art. 26</span> <span className="framework-chip">APRA CPS 230</span> <span className="framework-chip">ISO 42001 Cl. 8.1</span> <span className="framework-chip">NIST AI RMF GOVERN 1</span>
</div>
...
| Type | Example |
|------|---------|
| Regulatory breach | AI system used outside its intended purpose, breaching deployer obligations under EU AI Act Art. 26 |
...
**[▶ Play this scenario in the AI Risk Training Module](https://app.airiskpractice.org/#/scenario/f3-scope-creep)** — AI Scope Creep & Unauthorised Use Case Expansion, four personas, ~11 minutes.
