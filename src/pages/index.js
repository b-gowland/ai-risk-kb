...
const DOMAINS = [
  ...
  },
  {
    ...
    entries: 4, link: '/docs/domain-b-governance/b1-accountability',
  },
  {
    ...
    entries: 5, link: '/docs/domain-c-security/c2-prompt-injection',
  },
  {
...
export default function Home() {
  return (
    <Layout
      ...
      description="References explain the risks. This explains what to do. 26 AI risk entries across 7 domains, mapped to NIST AI RMF, OWASP LLM Top 10, EU AI Act, and ISO 42001."
    >
      <div className="hero-banner">
        <div className="hero-eyebrow">Open source · MIT licence · 26 entries · 7 domains</div>
